...
on a balanced trajectory preference dataset with targeted escalation supervision.

Strict Holdouts:
- RE-004, AMB-001, and RE-005 (and any same-lesson fingerprints) are held out for validation.
"""
...
def run_dpo_training_v4b(
    train_file: str = "data/preferences/dpo_train_formatted_v4b.jsonl",
    val_file: str = "data/preferences/dpo_val_formatted_v4b.jsonl",
    base_model_name: str = "Qwen/Qwen2.5-0.5B-Instruct",
    output_dir: str = "experiments/dpo_qwen05b_v4b",
    lora_r: int = 16,
    lora_alpha: int = 32,
    ...
    print("=" * 70, flush=True)
    print("STARTING DPO EXPERIMENT V4B: TARGETED ESCALATION PREFERENCE LEARNING", flush=True)
    print("=" * 70, flush=True)
    ...
    # 2. Prepare Datasets
    print("\n--- [2/6] Loading Formatted Datasets for DPO V4B ---", flush=True)
    ...
    # 6. Train
    print("\n--- [6/6] Executing DPO V4B Training ---", flush=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train DPO V4B LoRA Adapter")
    parser.add_argument("--train_file", default="data/preferences/dpo_train_formatted_v4b.jsonl")
    parser.add_argument("--val_file", default="data/preferences/dpo_val_formatted_v4b.jsonl")
    parser.add_argument("--base_model", default="Qwen/Qwen2.5-0.5B-Instruct")
    parser.add_argument("--output_dir", default="experiments/dpo_qwen05b_v4b")
    parser.add_argument("--epochs", type=int, default=3)
    parser.add_argument("--lr", type=float, default=5e-5)
    parser.add_argument("--beta", type=float, default=0.1)
    args = parser.parse_args()

    run_dpo_training_v4b(
