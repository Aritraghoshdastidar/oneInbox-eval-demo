"""DPO Experiment V3: Trajectory-Aware / Structured Tool-Use Preference Learning.

Fine-tunes Qwen2.5-0.5B-Instruct using Direct Preference Optimization (DPO)
on trajectory preference pairs with structured tool calls (<tool_call> tags).
...
def run_dpo_training_v3(
    train_file: str = "data/preferences/dpo_train_formatted_v3.jsonl",
    val_file: str = "data/preferences/dpo_val_formatted_v3.jsonl",
    base_model_name: str = "Qwen/Qwen2.5-0.5B-Instruct",
    output_dir: str = "experiments/dpo_qwen05b_v3",
    lora_r: int = 16,
    lora_alpha: int = 32,
    ...
    print("=" * 70, flush=True)
    print("STARTING DPO EXPERIMENT V3: TRAJECTORY TOOL-USE PREFERENCE OPTIMIZATION", flush=True)
    print("=" * 70, flush=True)
    ...
    # 2. Prepare Datasets
    print("\n--- [2/6] Loading Formatted Datasets for DPO V3 ---", flush=True)
    ...
    # 6. Train
    print("\n--- [6/6] Executing DPO V3 Training ---", flush=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train DPO V3 LoRA Adapter")
    parser.add_argument("--train_file", default="data/preferences/dpo_train_formatted_v3.jsonl")
    parser.add_argument("--val_file", default="data/preferences/dpo_val_formatted_v3.jsonl")
    parser.add_argument("--base_model", default="Qwen/Qwen2.5-0.5B-Instruct")
    parser.add_argument("--output_dir", default="experiments/dpo_qwen05b_v3")
